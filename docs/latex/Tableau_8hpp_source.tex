...
\DoxyCodeLine{123                 \textcolor{comment}{// if constant term is negative}}
...
\DoxyCodeLine{138                 \textcolor{comment}{// if constant term is negative }}
...
\DoxyCodeLine{153                 \textcolor{comment}{// if the constant term is negative}}
...
\DoxyCodeLine{213     \}}
\DoxyCodeLine{214     \textcolor{comment}{// adding constant term}}
...
\DoxyCodeLine{261     \} }
\DoxyCodeLine{262     \textcolor{comment}{// adding constant term  }}
...
\DoxyCodeLine{306     \}}
\DoxyCodeLine{307     \textcolor{comment}{// adding constant term}}
...
\DoxyCodeLine{346         \}}
\DoxyCodeLine{347     \}}
\DoxyCodeLine{348     \textcolor{comment}{// Adding constant term as 0 for objective function}}
...
\DoxyCodeLine{438 }
\DoxyCodeLine{439     \textcolor{comment}{// analyzing all coefficients of objective function row (apart from its constant term) }}
...
\DoxyCodeLine{481 }
\DoxyCodeLine{482             \textcolor{comment}{// calculating ratio between constant term and coefficient in current tableau row}}
